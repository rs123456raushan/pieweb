...
const Hero = () => {
  ...
  const scriptURL = "https://api.sheetbest.com/sheets/4399bc0d-fdbc-4514-9f47-42c579dbc912"
    ...
    <div className="heroWrapper">
      ...
      <div className="heroRight">
        ...
        >
          ...
          <div>
            <span>+91</span>
            <input onChange={(e) => setPhone(e.target.value)} type="text" name="phone" placeholder="Enter your phone no." />
          </div>
          <textarea onChange={(e) => setRequirements(e.target.value)} name="requirements" rows={5} placeholder="Describe your requirement"></textarea>
